...
const STRIP_CLUB_REP_DECAY_DAYS = 10	//3;
...
Game_Actor.prototype.customReq_stripperInviteVIP = function() {
	return !this.justOrgasmed() && $gameTroop.stripperBattle_validPatronsToInviteForVIP().length > 0 && $gameParty.stripperBattle_getCurrentTimeInSeconds() >= 0;
};
