...
Scene_Battle.prototype.create_layout_window = function() {
	...
	if (String(Moghunter.bhud_skill_layout) === "true") {
		this._skill_layout = new Sprite(ImageManager.loadBHud("Layout_Help"))
		...
		if(TextManager.isEnglish)
			...
			this._skill_layout_stamina = new Sprite(ImageManager.loadBHud("Layout_Skill_Stamina_RU"));
		else if(TextManager.isKorean)
			this._skill_layout_stamina = new Sprite(ImageManager.loadBHud("Layout_Skill_Stamina_KR"));
		else if(TextManager.isSpanish)
			this._skill_layout_stamina = new Sprite(ImageManager.loadBHud("Layout_Skill_Stamina_SP"));
		else if(TextManager.isSChinese)
			this._skill_layout_stamina = new Sprite(ImageManager.loadBHud("Layout_Skill_Stamina_SCH"));
		else if(TextManager.isTChinese)
			this._skill_layout_stamina = new Sprite(ImageManager.loadBHud("Layout_Skill_Stamina_TCH"));
		else
			this._skill_layout_stamina = new Sprite(ImageManager.loadBHud("Layout_Skill_Stamina"));
		...
		if(TextManager.isEnglish)
			...
			this._skill_layout_energy = new Sprite(ImageManager.loadBHud("Layout_Skill_Energy_RU"));
		else if(TextManager.isKorean)
			this._skill_layout_energy = new Sprite(ImageManager.loadBHud("Layout_Skill_Energy_KR"));
		else if(TextManager.isSpanish)
			this._skill_layout_energy = new Sprite(ImageManager.loadBHud("Layout_Skill_Energy_SP"));
		else if(TextManager.isSChinese)
			this._skill_layout_energy = new Sprite(ImageManager.loadBHud("Layout_Skill_Energy_SCH"));
		else if(TextManager.isTChinese)
			this._skill_layout_energy = new Sprite(ImageManager.loadBHud("Layout_Skill_Energy_TCH"));
		else
			this._skill_layout_energy = new Sprite(ImageManager.loadBHud("Layout_Skill_Energy"));
		...
		if(TextManager.isEnglish)
			...
			this._skill_layout_sexual = new Sprite(ImageManager.loadBHud("Layout_Skill_Sexual_RU"));
		else if(TextManager.isKorean)
			this._skill_layout_sexual = new Sprite(ImageManager.loadBHud("Layout_Skill_Sexual_KR"));
		else if(TextManager.isSpanish)
			this._skill_layout_sexual = new Sprite(ImageManager.loadBHud("Layout_Skill_Sexual_SP"));
		else if(TextManager.isSChinese)
			this._skill_layout_sexual = new Sprite(ImageManager.loadBHud("Layout_Skill_Sexual_SCH"));
		else if(TextManager.isTChinese)
			this._skill_layout_sexual = new Sprite(ImageManager.loadBHud("Layout_Skill_Sexual_TCH"));
		else 
			this._skill_layout_sexual = new Sprite(ImageManager.loadBHud("Layout_Skill_Sexual"));
		...
		if(TextManager.isEnglish)
			...
			this._skill_layout_willpower = new Sprite(ImageManager.loadBHud("Layout_Skill_Willpower_RU"));
		else if(TextManager.isKorean)
			this._skill_layout_willpower = new Sprite(ImageManager.loadBHud("Layout_Skill_Willpower_KR"));
		else if(TextManager.isSpanish)
			this._skill_layout_willpower = new Sprite(ImageManager.loadBHud("Layout_Skill_Willpower_SP"));
		else if(TextManager.isSChinese)
			this._skill_layout_willpower = new Sprite(ImageManager.loadBHud("Layout_Skill_Willpower_SCH"));
		else if(TextManager.isTChinese)
			this._skill_layout_willpower = new Sprite(ImageManager.loadBHud("Layout_Skill_Willpower_TCH"));
		else
			this._skill_layout_willpower = new Sprite(ImageManager.loadBHud("Layout_Skill_Willpower"));
		...
		if(TextManager.isEnglish)
			...
			this._skill_layout_special = new Sprite(ImageManager.loadBHud("Layout_Skill_Special_RU"));
		else if(TextManager.isKorean)
			this._skill_layout_special = new Sprite(ImageManager.loadBHud("Layout_Skill_Special_KR"));
		else if(TextManager.isSpanish)
			this._skill_layout_special = new Sprite(ImageManager.loadBHud("Layout_Skill_Special_SP"));
		else if(TextManager.isSChinese)
			this._skill_layout_special = new Sprite(ImageManager.loadBHud("Layout_Skill_Special_SCH"));
		else if(TextManager.isTChinese)
			this._skill_layout_special = new Sprite(ImageManager.loadBHud("Layout_Skill_Special_TCH"));
		else 
			this._skill_layout_special = new Sprite(ImageManager.loadBHud("Layout_Skill_Special"));
...
Scene_Battle.prototype.updateLayoutWindow = function() {
	...
	if (this._skill_layout) {
		...
		if(this._skillWindow.isOpenAndActive()) {
			let stypeId = this._skillWindow._stypeId;
			switch(stypeId) {
...
Battle_Hud.prototype.refresh_states2 = function() {
	...
	let icons = this._battler.allIcons().slice(0,w);
