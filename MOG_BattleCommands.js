...
const REM_BHD_BC_DEFEATED_FIVE_X = -530;
const REM_BHD_BC_DEFEATED_FIVE_Y = 35;
...
const REM_BHD_BC_GYM_BATTLE_STANDBY_X = 290;
const REM_BHD_BC_GYM_BATTLE_STANDBY_Y = -140;

const REM_BHD_BC_GYM_BATTLE_TEKOKI_X = 480;
const REM_BHD_BC_GYM_BATTLE_TEKOKI_Y = -210;

const REM_BHD_BC_GYM_BATTLE_KISU_X = 500;
const REM_BHD_BC_GYM_BATTLE_KISU_Y = -190;

const REM_BHD_BC_GYM_BATTLE_FERA_X = -190;
const REM_BHD_BC_GYM_BATTLE_FERA_Y = -170;

const REM_BHD_BC_GYM_BATTLE_PAIZURI_X = -220;
const REM_BHD_BC_GYM_BATTLE_PAIZURI_Y = -200;

const REM_BHD_BC_GYM_BATTLE_RINKAN_X = -540;
const REM_BHD_BC_GYM_BATTLE_RINKAN_Y = 30;
	...
	for (var i = 0; i < this._list.length; i++) {
		 ...
		 for (var r = 0; r < this._list.length; r++) {
			...
			if(this._list[r].symbol == "guard") {
				...
				let statusName = 'Com_Status';
				if(DLC_HAIR) {
					switch(ConfigManager.KarrynHairColor) {
						case HAIR_COLOR_BLOND_ID:
							statusName += '_' + HAIR_COLOR_BLOND_NAME;
						break;
						case HAIR_COLOR_BLACK_ID:
							statusName += '_' + HAIR_COLOR_BLACK_NAME;
						break;
					}
				}
				this._com_images.push(ImageManager.loadBcom(statusName));
			}
		    //else this._com_images.push(ImageManager.loadBcom("Com_" + this._list[r].name));
			else {
				let comName = this._list[r].ext;
				switch(comName) {
					case 3:
					case 15:
					case 17:
					...
					case 22:
						if(DLC_HAIR) {
							switch(ConfigManager.KarrynHairColor) {
								case HAIR_COLOR_BLOND_ID:
									comName += '_' + HAIR_COLOR_BLOND_NAME;
								break;
								case HAIR_COLOR_BLACK_ID:
									comName += '_' + HAIR_COLOR_BLACK_NAME;
								break;
							}
						}
					break;
				}
				this._com_images.push(ImageManager.loadBcom("Com_" + comName));
			}
		 };
	};
...
Window_ActorCommand.prototype.create_layout = function() {	
	...
	case POSE_TRAINER_STANDBY:
		this._layout.x += REM_BHD_BC_GYM_BATTLE_STANDBY_X;
		this._layout.y += REM_BHD_BC_GYM_BATTLE_STANDBY_Y;
	break;
	case POSE_TRAINER_TEKOKI:
		this._layout.x += REM_BHD_BC_GYM_BATTLE_TEKOKI_X;
		this._layout.y += REM_BHD_BC_GYM_BATTLE_TEKOKI_Y;
	break;
	case POSE_TRAINER_KISU:
		this._layout.x += REM_BHD_BC_GYM_BATTLE_KISU_X;
		this._layout.y += REM_BHD_BC_GYM_BATTLE_KISU_Y;
	break;
	case POSE_TRAINER_FERA:
		this._layout.x += REM_BHD_BC_GYM_BATTLE_FERA_X;
		this._layout.y += REM_BHD_BC_GYM_BATTLE_FERA_Y;
	break;
	case POSE_TRAINER_PAIZURI:
		this._layout.x += REM_BHD_BC_GYM_BATTLE_PAIZURI_X;
		this._layout.y += REM_BHD_BC_GYM_BATTLE_PAIZURI_Y;
	break;
	case POSE_TRAINER_RINKAN:
		this._layout.x += REM_BHD_BC_GYM_BATTLE_RINKAN_X;
		this._layout.y += REM_BHD_BC_GYM_BATTLE_RINKAN_Y;
	break;
	}
...
Window_ActorCommand.prototype.create_com_name = function() {	
	...
	break;
	case POSE_TRAINER_STANDBY:
		this._com_name.x += REM_BHD_BC_GYM_BATTLE_STANDBY_X;
		this._com_name.y += REM_BHD_BC_GYM_BATTLE_STANDBY_Y;
	break;
	case POSE_TRAINER_TEKOKI:
		this._com_name.x += REM_BHD_BC_GYM_BATTLE_TEKOKI_X;
		this._com_name.y += REM_BHD_BC_GYM_BATTLE_TEKOKI_Y;
	break;
	case POSE_TRAINER_KISU:
		this._com_name.x += REM_BHD_BC_GYM_BATTLE_KISU_X;
		this._com_name.y += REM_BHD_BC_GYM_BATTLE_KISU_Y;
	break;
	case POSE_TRAINER_FERA:
		this._com_name.x += REM_BHD_BC_GYM_BATTLE_FERA_X;
		this._com_name.y += REM_BHD_BC_GYM_BATTLE_FERA_Y;
	break;
	case POSE_TRAINER_PAIZURI:
		this._com_name.x += REM_BHD_BC_GYM_BATTLE_PAIZURI_X;
		this._com_name.y += REM_BHD_BC_GYM_BATTLE_PAIZURI_Y;
	break;
	case POSE_TRAINER_RINKAN:
		this._com_name.x += REM_BHD_BC_GYM_BATTLE_RINKAN_X;
		this._com_name.y += REM_BHD_BC_GYM_BATTLE_RINKAN_Y;
	break;
	}
...
Window_ActorCommand.prototype.refresh_bitmap_com = function() {	
	...
	for (var i = 0; i < this.maxCom(); i++) {	
		...
		break;
		case POSE_TRAINER_STANDBY:
			this._com_sprites[i].x += REM_BHD_BC_GYM_BATTLE_STANDBY_X;
			this._com_sprites[i].y += REM_BHD_BC_GYM_BATTLE_STANDBY_Y;
		break;
		case POSE_TRAINER_TEKOKI:
			this._com_sprites[i].x += REM_BHD_BC_GYM_BATTLE_TEKOKI_X;
			this._com_sprites[i].y += REM_BHD_BC_GYM_BATTLE_TEKOKI_Y;
		break;
		case POSE_TRAINER_KISU:
			this._com_sprites[i].x += REM_BHD_BC_GYM_BATTLE_KISU_X;
			this._com_sprites[i].y += REM_BHD_BC_GYM_BATTLE_KISU_Y;
		break;
		case POSE_TRAINER_FERA:
			this._com_sprites[i].x += REM_BHD_BC_GYM_BATTLE_FERA_X;
			this._com_sprites[i].y += REM_BHD_BC_GYM_BATTLE_FERA_Y;
		break;
		case POSE_TRAINER_PAIZURI:
			this._com_sprites[i].x += REM_BHD_BC_GYM_BATTLE_PAIZURI_X;
			this._com_sprites[i].y += REM_BHD_BC_GYM_BATTLE_PAIZURI_Y;
		break;
		case POSE_TRAINER_RINKAN:
			this._com_sprites[i].x += REM_BHD_BC_GYM_BATTLE_RINKAN_X;
			this._com_sprites[i].y += REM_BHD_BC_GYM_BATTLE_RINKAN_Y;
		break;
		}
...
Window_ActorCommand.prototype.update_position = function(i) {
	if (this._com_mode_b === 0) {
		...
		break;
		case POSE_TRAINER_STANDBY:
			this._np[0] += REM_BHD_BC_GYM_BATTLE_STANDBY_X;
			this._np[1] += REM_BHD_BC_GYM_BATTLE_STANDBY_Y;
		break;
		case POSE_TRAINER_TEKOKI:
			this._np[0] += REM_BHD_BC_GYM_BATTLE_TEKOKI_X;
			this._np[1] += REM_BHD_BC_GYM_BATTLE_TEKOKI_Y;
		break;
		case POSE_TRAINER_KISU:
			this._np[0] += REM_BHD_BC_GYM_BATTLE_KISU_X;
			this._np[1] += REM_BHD_BC_GYM_BATTLE_KISU_Y;
		break;
		case POSE_TRAINER_FERA:
			this._np[0] += REM_BHD_BC_GYM_BATTLE_FERA_X;
			this._np[1] += REM_BHD_BC_GYM_BATTLE_FERA_Y;
		break;
		case POSE_TRAINER_PAIZURI:
			this._np[0] += REM_BHD_BC_GYM_BATTLE_PAIZURI_X;
			this._np[1] += REM_BHD_BC_GYM_BATTLE_PAIZURI_Y;
		break;
		case POSE_TRAINER_RINKAN:
			this._np[0] += REM_BHD_BC_GYM_BATTLE_RINKAN_X;
			this._np[1] += REM_BHD_BC_GYM_BATTLE_RINKAN_Y;
		break;
		}
