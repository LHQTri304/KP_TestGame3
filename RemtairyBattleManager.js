...
//Captain Battle 
const BM_PLVL5_BOSS_BGM_NAME = "Battle6"; 
const BM_PLVL5_BOSS_BGM_VOLUME = 90;
//Final Battle 
const BM_FINAL_BOSS_BGM_NAME = "Boss2"; 
const BM_FINAL_BOSS_BGM_VOLUME = 80;

//Custom Battle
const BM_PLVL5_CUSTOM_BATTLE_BGM_NAME = "Battle_Night2"; 
const BM_PLVL5_CUSTOM_BATTLE_BGM_VOLUME = 70;
//Endless Battle Start
const BM_PLVL5_ENDLESS_BATTLE_BGM_NAME = "Battle1"; 
const BM_PLVL5_ENDLESS_BATTLE_BGM_VOLUME = 65;
//Endless
const BM_PLVL5_ENDLESS_WAVE_6_TO_9_BGM_NAME = "Battle7"; 
const BM_PLVL5_ENDLESS_WAVE_6_TO_9_BGM_VOLUME = 70;
const BM_PLVL5_ENDLESS_WAVE_11_TO_14_BGM_NAME = "Battle5"; 
const BM_PLVL5_ENDLESS_WAVE_11_TO_14_BGM_VOLUME = 65;
const BM_PLVL5_ENDLESS_WAVE_16_TO_19_BGM_NAME = "Battle8"; 
const BM_PLVL5_ENDLESS_WAVE_16_TO_19_BGM_VOLUME = 90;
const BM_PLVL5_ENDLESS_WAVE_21_TO_24_BGM_NAME = "Battle_Invasion1"; 
const BM_PLVL5_ENDLESS_WAVE_21_TO_24_BGM_VOLUME = 90;
const BM_PLVL5_ENDLESS_WAVE_26_TO_29_BGM_NAME = "Battle_EB1"; 
const BM_PLVL5_ENDLESS_WAVE_26_TO_29_BGM_VOLUME = 65;
const BM_PLVL5_ENDLESS_WAVE_31_TO_34_BGM_NAME = "Battle_Night1"; 
const BM_PLVL5_ENDLESS_WAVE_31_TO_34_BGM_VOLUME = 80;
const BM_PLVL5_ENDLESS_WAVE_36_TO_39_BGM_NAME = "Battle3"; 
const BM_PLVL5_ENDLESS_WAVE_36_TO_39_BGM_VOLUME = 80;
const BM_PLVL5_ENDLESS_WAVE_41_TO_44_BGM_NAME = "Battle6"; 
const BM_PLVL5_ENDLESS_WAVE_41_TO_44_BGM_VOLUME = 90;
const BM_PLVL5_ENDLESS_WAVE_46_TO_49_BGM_NAME = "Boss1"; 
const BM_PLVL5_ENDLESS_WAVE_46_TO_49_BGM_VOLUME = 90;
const BM_PLVL5_ENDLESS_WAVE_5_TO_25_MOD5_BGM_NAME = "Battle2"; 
const BM_PLVL5_ENDLESS_WAVE_5_TO_25_MOD5_BGM_VOLUME = 80;
const BM_PLVL5_ENDLESS_WAVE_30_TO_45_MOD5_BGM_NAME = "Battle4"; 
const BM_PLVL5_ENDLESS_WAVE_30_TO_45_MOD5_BGM_VOLUME = 80;
const BM_PLVL5_ENDLESS_WAVE_50_BGM_NAME = "Title1";
const BM_PLVL5_ENDLESS_WAVE_50_BGM_VOLUME = 80;
...
//trainer job
const BM_TRAINER_JOB_BGM_NAME = "Job3";
const BM_TRAINER_JOB_BGM_PAN = 0;
const BM_TRAINER_JOB_BGM_PITCH = 100;
const BM_TRAINER_JOB_BGM_VOLUME = 95;

//trainer sex
const BM_TRAINER_SEX_BGM_NAME = "H_Job2";
const BM_TRAINER_SEX_BGM_PAN = 0;
const BM_TRAINER_SEX_BGM_PITCH = 100;
const BM_TRAINER_SEX_BGM_VOLUME = 95;

const BM_TRAINER_RINKAN_BGM_NAME = "H_Job1";
const BM_TRAINER_RINKAN_BGM_PAN = 0;
const BM_TRAINER_RINKAN_BGM_PITCH = 100;
const BM_TRAINER_RINKAN_BGM_VOLUME = 95;
...
//defeated guard - bitch end
const BM_DEFEATED_GUARD_BITCH_END_BGM_NAME = "Ending3";
const BM_DEFEATED_GUARD_BITCH_END_BGM_PAN = 0;
const BM_DEFEATED_GUARD_BITCH_END_BGM_PITCH = 100;
const BM_DEFEATED_GUARD_BITCH_END_BGM_VOLUME = 90;
...
const BM_MAS_BGM_BGM_PAN = 0;
const BM_MAS_BGM_BGM_PITCH = 100;
const BM_MAS_BGM_VOLUME = 80;

//invasion battle bgm
const BM_INVASION_BATTLE_BGM_NAME = "Battle_Invasion1";
const BM_INVASION_BATTLE_BGM_PAN = 0;
const BM_INVASION_BATTLE_BGM_PITCH = 100;
const BM_INVASION_BATTLE_BGM_VOLUME = 90;
...
BattleManager.playBattleBgm = function() {
	...
	if(Karryn.isInMasturbationCouchPose()) {
		...
		bgmPan = BM_MAS_BGM_BGM_PAN;
		bgmPitch = BM_MAS_BGM_BGM_PITCH;
		...
		if(Karryn.isInDefeatedLevel1Pose()) {
			...
			if(useSluttyDefeatedVersion) {
				bgmName = BM_DEFEATED_LV5_SLUTTY_BGM_NAME;
				bgmPan = BM_DEFEATED_LV5_SLUTTY_BGM_PAN;
				bgmPitch = BM_DEFEATED_LV5_SLUTTY_BGM_PITCH;
				bgmVolume = BM_DEFEATED_LV5_SLUTTY_BGM_VOLUME;
			}
			else {
				bgmName = BM_DEFEATED_LV5_NORMAL_BGM_NAME;
				bgmPan = BM_DEFEATED_LV5_NORMAL_BGM_PAN;
				bgmPitch = BM_DEFEATED_LV5_NORMAL_BGM_PITCH;
				bgmVolume = BM_DEFEATED_LV5_NORMAL_BGM_VOLUME;
			}
		}
		else if(Karryn.isInDefeatedGuardPose()) {
			if($gameSwitches.value(SWITCH_BITCH_ENDING_ID)) {
				bgmName = BM_DEFEATED_GUARD_BITCH_END_BGM_NAME;
				bgmPan = BM_DEFEATED_GUARD_BITCH_END_BGM_PAN;
				bgmPitch = BM_DEFEATED_GUARD_BITCH_END_BGM_PITCH;
				bgmVolume = BM_DEFEATED_GUARD_BITCH_END_BGM_VOLUME;
			}
			else if(useSluttyDefeatedVersion) {
	...
	else if($gameSwitches.value(SWITCH_INVASION_BATTLE_ID)) {
		bgmName = BM_INVASION_BATTLE_BGM_NAME;
		bgmPan = BM_INVASION_BATTLE_BGM_PAN;
		bgmPitch = BM_INVASION_BATTLE_BGM_PITCH;
		bgmVolume = BM_INVASION_BATTLE_BGM_VOLUME;
	}
		...
		return;
		/*
		bgmName = BM_TRAINER_JOB_BGM_NAME;
		bgmPan = BM_TRAINER_JOB_BGM_PAN;
		bgmPitch = BM_TRAINER_JOB_BGM_PITCH;
		bgmVolume = BM_TRAINER_JOB_BGM_VOLUME;
		*/
	}
	else {
		...
		if(mapId === MAP_ID_KARRYN_OFFICE && $gameVariables.value(VARIABLE_PROLOGUE_PROGRESS_ID) === 5 && !$gameSwitches.value(SWITCH_PROLOGUE_ENDED)) {
			...
			if(mapId === MAP_ID_EB_CONTROL && $gameParty._isBossBattleFlag) {
				bgmName = BM_FINAL_BOSS_BGM_NAME;
				bgmVolume = BM_FINAL_BOSS_BGM_VOLUME;
			}
			else if((mapId === MAP_ID_EB_HALLWAY || mapId === MAP_ID_YARD || mapId === MAP_ID_OUTSIDE) && $gameParty.isNightBattle()) {
				if(sluttyVersionBgm) {
			...
			if($gameParty._isBossBattleFlag) {
				bgmName = BM_PLVL5_BOSS_BGM_NAME;
				bgmVolume = BM_PLVL5_BOSS_BGM_VOLUME;
			}
			else if(Prison.isCustomBattle()) {
				bgmName = BM_PLVL5_CUSTOM_BATTLE_BGM_NAME;
				bgmVolume = BM_PLVL5_CUSTOM_BATTLE_BGM_VOLUME;
			}
			else if(Prison.isEndlessBattle()) {
				bgmName = BM_PLVL5_ENDLESS_BATTLE_BGM_NAME;
				bgmVolume = BM_PLVL5_ENDLESS_BATTLE_BGM_VOLUME;
			}
		}
	}
...
BattleManager.playSpecialBgm_TrainerWork = function() {
	if(!this._playingSpecialBgm) {
		this._normalBgm = AudioManager.saveBgm();
		if(this._playingDownBgmChange) {
			this._playingDownBgmChange = false;
    ...
    AudioManager.playBgm({name:BM_TRAINER_JOB_BGM_NAME, pan:BM_TRAINER_JOB_BGM_PAN, pitch:BM_TRAINER_JOB_BGM_PITCH, pos:0, volume: BM_TRAINER_JOB_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = true;
};
BattleManager.playSpecialBgm_TrainerSex = function() {
	if(!this._playingSpecialBgm) {
		this._normalBgm = AudioManager.saveBgm();
		if(this._playingDownBgmChange) {
			this._playingDownBgmChange = false;
    ...
    AudioManager.playBgm({name:BM_TRAINER_SEX_BGM_NAME, pan:BM_TRAINER_SEX_BGM_PAN, pitch:BM_TRAINER_SEX_BGM_PITCH, pos:0, volume: BM_TRAINER_SEX_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = true;
};

BattleManager.playSpecialBgm_TrainerRinkan = function() {
	if(!this._playingSpecialBgm) {
		this._normalBgm = AudioManager.saveBgm();
		if(this._playingDownBgmChange) {
			this._playingDownBgmChange = false;
    ...
    AudioManager.playBgm({name:BM_TRAINER_RINKAN_BGM_NAME, pan:BM_TRAINER_RINKAN_BGM_PAN, pitch:BM_TRAINER_RINKAN_BGM_PITCH, pos:0, volume: BM_TRAINER_RINKAN_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = true;
};
...
BattleManager.playEndlessBgm_Wave6to9 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_6_TO_9_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_6_TO_9_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave11to14 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_11_TO_14_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_11_TO_14_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave16to19 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_16_TO_19_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_16_TO_19_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave21to24 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_21_TO_24_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_21_TO_24_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave26to29 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_26_TO_29_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_26_TO_29_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave31to34 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_31_TO_34_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_31_TO_34_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave36to39 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_36_TO_39_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_36_TO_39_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave41to44 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_41_TO_44_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_41_TO_44_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave46to49 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_46_TO_49_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_46_TO_49_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave5to25_mod5 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_5_TO_25_MOD5_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_5_TO_25_MOD5_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave30to45_mod5 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_30_TO_45_MOD5_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_30_TO_45_MOD5_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
BattleManager.playEndlessBgm_Wave50 = function() {
    AudioManager.playBgm({name:BM_PLVL5_ENDLESS_WAVE_50_BGM_NAME, pan:0, pitch:100, pos:0, volume: BM_PLVL5_ENDLESS_WAVE_50_BGM_VOLUME});
	AudioManager.stopBgs();
	this._playingSpecialBgm = false;
	this._playingDownBgmChange = false;
};
...
BattleManager.refreshAllBattlerPoses = function(onlyChangeIfDifferent) {
	...
	for(let battler of members) {
		if(!battler) { continue; }
		battler.refreshPose(onlyChangeIfDifferent);	
	}
};
...
Game_Action.prototype.isActorSexStanceSkill = function() {
    if(this.isSkill()) {
        let skillId = this._item._itemId;
		return skillId === SKILL_ENDURE_PLEASURE_ID || skillId === SKILL_WAIT_OUT_PLEASURE_ID || skillId === SKILL_OPEN_PLEASURE_ID|| skillId === SKILL_KARRYN_OPEN_PLEASURE_3TURNS_ID || skillId === SKILL_KARRYN_OPEN_PLEASURE_5TURNS_ID || skillId === SKILL_KARRYN_OPEN_PLEASURE_10TURNS_ID || skillId === SKILL_KARRYN_OPEN_PLEASURE_BATTLE_ID || skillId === SKILL_KARRYN_OPEN_PLEASURE_AUTO_MANUAL_ID;
...
BattleManager.initVictoryData = function() {
    ...
    this._victoryStep = 0;
	this._victoryPhaseRewardsCalculated = false;
};

BattleManager.onStartOfConBat = function() {
	let group = $gameParty.members();
	for(let i = 0; i < group.length; i++) {
		let actor = group[i];
		if(!actor) { continue; }
...
BattleManager.processVictory = function() {
	...
	if(!this._victoryPhaseRewardsCalculated) {
		this.getDataRewardsCB();
		this._victoryPhaseRewardsCalculated = true;
	}
    ...
    if(!$gameSystem.skipVictoryAftermath()) {
		...
		if(Karryn.isUsingThisTitle(TITLE_ID_DESCENSION_D2_HARD)) $gameParty.increaseFatigueGain(PRISON_FATIGUE_FROM_D2_TITLE_REWARD, true);
...
BattleManager.makeRewards = function() {
	...
	*/
	...
	//Extra gold
	if(this._rewards._extraGoldReward > 0)
		this._rewards._extraGoldReward += Math.random() * this._rewards._extraGoldReward * 0.1;
...
BattleManager.checkBattleEndJobs = function() {
	...
	if(Karryn.isInWaitressServingPose()) {
		...
		else if($gameParty.trainerBattle_getCurrentTimeInSeconds() >= $gameParty._trainerBattle_timeLimit) {
			this.processVictory();
            return true;
		}
		else if($gameTroop.trainerBattle_noMoreGymGoers()) {
			this.processVictory();
            return true;
		}
		else if($gameParty.isAllDead()) {
...
BattleManager.processDefeat = function() {
	...
	else if(!Karryn.isInMasturbationCouchPose() && !$gameParty.isInGloryBattle) {
